export const elements = {
  darkModeButton: document.querySelector('.darkmode-btn'),
  lightModeButton: document.querySelector('.lightmode-btn'),
  ...
  forestSoundInput: document.querySelector('#sound-forest'),
